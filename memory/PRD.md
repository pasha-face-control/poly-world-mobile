...
- **Roads**: a land unit **standing on a road tile moves twice as far** that turn (move ×2, in `grid.ts` `reachableTiles`); roads still carry units through forest/mountain without stopping.
